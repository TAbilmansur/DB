...
--10
select code,(select count(*) from employees where department = code) from departments; 
--11
select code from departments
where (select count(*) from employees where department = code) > 2;
--12
select name from departments
where budget = (select distinct on (budget) budget from departments order by budget desc offset 1 limit 1);
--13
select name,lastname from employees
where (select budget from departments where code = department) = (select min(budget) from departments);
--14
...
where department in (select code from departments where name = 'Research');
--18
delete from employees
where department in (select code from departments where name = 'IT');
--19
delete from employees;